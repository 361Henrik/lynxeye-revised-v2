...
export function buildCopyText(state: SimulatorState) {
  return [
    "Accelerate Lynxeye with AI, cohort-first back-of-envelope model",
    "",
    "Executive question",
    ...
    `Methodology cohort: ${formatPeople(state.cohortSize)}`,
    ...
    "",
    "Caveat",
    "This is not a claim that everyone becomes an AI power user. It sizes the value of a focused capability group creating reusable practice for the wider firm.",
